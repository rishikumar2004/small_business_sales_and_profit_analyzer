...
import reportsBg from '../assets/images/reports_bg.png';
...
export default function Reports() {
    ...
    // Style for transparent cards
    const cardStyle = {
        background: theme === 'light' ? 'rgba(255, 255, 255, 0.7)' : 'rgba(30, 41, 59, 0.4)', // More transparent
            ...
            <div className="fade-in" style={{ position: 'relative', zIndex: 1 }}>
                <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 1rem' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
                        <div className="card" style={{ ...cardStyle, borderLeft: '4px solid var(--success)', padding: '1.5rem' }}>
                    ...
                    {/* Filters */}
                    <div className="card" style={{ ...cardStyle, marginBottom: '2rem', padding: '1.5rem', position: 'relative', zIndex: 50 }}>
                    ...
                    <div className="card" style={cardStyle}>
                        <div className="flex-between" style={{ marginBottom: '1.5rem', padding: '1.5rem 1.5rem 0 1.5rem' }}>
